...
set(PACKAGE_NAME ${CMAKE_PROJECT_NAME} CACHE INTERNAL "")
set(PACKAGE_VERSION ${CMAKE_PROJECT_VERSION} CACHE INTERNAL "")

set(CPACK_PACKAGE_FILE_NAME "${PACKAGE_NAME}-${PACKAGE_VERSION}-${CMAKE_CXX_COMPILER_ID}-${CMAKE_CXX_COMPILER_VERSION}")
